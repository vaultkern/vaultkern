...
describe("registration detection fill flow", () => {
  ...
  it("fails closed when login and registration forms coexist without focus", () => {
    document.body.innerHTML = `
      <form id="login-form">
        <h2>Sign in</h2>
        <input name="login_user" type="email" autocomplete="username" />
  ...
  it("fails closed for ambiguous generic password and confirmation roles", () => {
    document.body.innerHTML = `
      <form>
        <input id="email" name="email" type="email" autocomplete="username" />
  ...
  it("fails closed when focus is in an unrelated non-credential physical scope", () => {
    document.body.innerHTML = `
      <form id="search-form">
  ...
  it("fails closed when focus is in an unrelated newsletter physical scope", () => {
    document.body.innerHTML = `
